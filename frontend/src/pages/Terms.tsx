...
export default function Terms() {
  return (
    <div className="max-w-3xl mx-auto">
      <Link to="/" className="inline-flex items-center gap-2 px-4 py-2 border border-gray-200 rounded-xl text-gray-600 hover:text-primary-600 hover:bg-primary-50 hover:border-primary-200 mb-5 transition text-sm font-medium">
      ...
      <div className="bg-white rounded-2xl border p-6 md:p-10 prose prose-sm max-w-none">
