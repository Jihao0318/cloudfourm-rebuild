  ...
  return (
    ...
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="/edit-profile" element={<Suspense fallback={<PageSkeleton />}><EditProfile /></Suspense>} />
        <Route path="/delete-account" element={<Suspense fallback={<PageSkeleton />}><DeleteAccount /></Suspense>} />
